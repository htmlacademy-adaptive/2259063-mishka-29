...
const watcher = () => {
  ...
  gulp.watch(
    ...
    gulp.series(copyImages, createWebp, styles, html, reload)
  );
  gulp.watch(
    "source/img/icons/*.svg",
    gulp.series(svgSprite, styles, html, reload)
  );
};
...
export const build = gulp.series(
  ...
  copy,
  optimizeImages,
  gulp.parallel(styles, html, scripts, optimizeSvg, svgSprite, createWebp)
);
